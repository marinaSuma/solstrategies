...
const useInitWidget = (defaultOptions, userOptions, widgetKey, src) => {
  ...
  runtimeConfig?.overrideDefaults === true ? userOptions || defaultOptions : { ...defaultOptions, ...userOptions };
...
export {
  symbolInfoOptions as s,
  tickerTapeOptions as t,
  useInitWidget as u
};
//# sourceMappingURL=useInitWidget-DtHaI5KL.js.map
