import { a as _export_sfc, b as __nuxt_component_1$1, _ as __nuxt_component_0$1, S as ScrollTrigger } from "../server.mjs";
import { useTemplateRef, mergeProps, withCtx, createTextVNode, createVNode, useSSRContext, ref, toDisplayString } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderAttr } from "vue/server-renderer";
import { g as gsapWithCSS } from "./SectionCta-C2cdteWZ.js";
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_MediaImg = __nuxt_component_1$1;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(teamGroups, (group, gIndex) => {
        ...
        ssrRenderList(group.members, (member, mIndex) => {
          ...
          _push(`</div></div><a class="text"${ssrRenderAttr("href", member.url)} data-v-2c01121a>${member.description ?? ""}</a><div class="linkTeam" data-v-2c01121a><a${ssrRenderAttr("href", member.url)} class="btn" data-v-2c01121a> Read bio `);
          _push(ssrRenderComponent(_component_MediaImg, {
            class: "bioArrow",
            src: "/bio.svg",
            alt: "Read bio"
...
//# sourceMappingURL=SectionAboutTeam-BZh0aYIu.js.map
