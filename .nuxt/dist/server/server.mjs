import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, defineComponent, createElementBlock, provide, cloneVNode, h, isRef, ref, resolveComponent, computed, isShallow, isReactive, toRaw, defineAsyncComponent, unref, toValue, watch, useAttrs, mergeProps, useSSRContext, createVNode, resolveDynamicComponent, withCtx, renderSlot, createTextVNode, openBlock, createElementVNode, useTemplateRef, nextTick, onScopeDispose, shallowReadonly, watchEffect, toDisplayString, onMounted, Suspense, Fragment, onErrorCaptured, onServerPrefetch, createApp } from "vue";
import { $fetch } from "/Users/marina/Trabajos/Pia/solstrategies/repository/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/marina/Trabajos/Pia/solstrategies/repository/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/marina/Trabajos/Pia/solstrategies/repository/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, getRequestHeaders, getRequestHeader, setCookie, getCookie, deleteCookie, appendHeader } from "/Users/marina/Trabajos/Pia/solstrategies/repository/node_modules/h3/dist/index.mjs";
...
import { toRouteMatcher, createRouter } from "/Users/marina/Trabajos/Pia/solstrategies/repository/node_modules/radix3/dist/index.mjs";
import { defu } from "/Users/marina/Trabajos/Pia/solstrategies/repository/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash, parseURL, withLeadingSlash, withBase, stringifyQuery, encodeParam, encodePath } from "/Users/marina/Trabajos/Pia/solstrategies/repository/node_modules/ufo/dist/index.mjs";
import { klona } from "/Users/marina/Trabajos/Pia/solstrategies/repository/node_modules/klona/dist/index.mjs";
import { useHead as useHead$1, headSymbol as headSymbol$1, useSeoMeta as useSeoMeta$1 } from "/Users/marina/Trabajos/Pia/solstrategies/repository/node_modules/@unhead/vue/dist/index.mjs";
import { InferSeoMetaPlugin } from "@unhead/addons";
import { TemplateParamsPlugin } from "unhead/plugins";
import { titleCase, camelCase } from "/Users/marina/Trabajos/Pia/solstrategies/repository/node_modules/scule/dist/index.mjs";
import { SchemaOrgUnheadPlugin, defineWebSite, defineWebPage } from "@unhead/schema-org/vue";
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrRenderSlot, ssrRenderComponent, ssrRenderVNode, ssrRenderClass, ssrInterpolate, ssrRenderStyle, ssrRenderSuspense } from "vue/server-renderer";
import { parse } from "/Users/marina/Trabajos/Pia/solstrategies/repository/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import destr from "/Users/marina/Trabajos/Pia/solstrategies/repository/node_modules/destr/dist/index.mjs";
import { isEqual } from "/Users/marina/Trabajos/Pia/solstrategies/repository/node_modules/ohash/dist/index.mjs";
...
const _routes = [
  {
    name: "blog",
    path: "/blog",
    component: () => import("./_nuxt/blog-BKr971K9.js")
  },
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-D7TivRyU.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CE3CVpAw.js")
  },
  {
    name: "singleTeam",
    path: "/singleTeam",
    component: () => import("./_nuxt/singleTeam-BeZs201C.js")
  },
  {
    name: "investor-relations",
    path: "/investor-relations",
    component: () => import("./_nuxt/investor-relations-C8oLuLfw.js")
  }
];
...
const LazyIconAppstore = defineAsyncComponent(() => import("./_nuxt/appstore-s0hQ1Viv.js").then((r) => r["default"] || r.default || r));
const LazyIconArrow = defineAsyncComponent(() => Promise.resolve().then(() => arrow).then((r) => r["default"] || r.default || r));
const LazyIconArrowslide = defineAsyncComponent(() => import("./_nuxt/arrowslide-D9TeW5f3.js").then((r) => r["default"] || r.default || r));
const LazyIconChevron = defineAsyncComponent(() => Promise.resolve().then(() => chevron).then((r) => r["default"] || r.default || r));
const LazyIconCirclecenter = defineAsyncComponent(() => import("./_nuxt/circlecenter-DPhmquOh.js").then((r) => r["default"] || r.default || r));
const LazyIconCircleleft = defineAsyncComponent(() => import("./_nuxt/circleleft-DfZMv5RE.js").then((r) => r["default"] || r.default || r));
const LazyIconCircleright = defineAsyncComponent(() => import("./_nuxt/circleright-Dwbxe38P.js").then((r) => r["default"] || r.default || r));
const LazyIconClose = defineAsyncComponent(() => import("./_nuxt/close-C8XMkjCF.js").then((r) => r["default"] || r.default || r));
const LazyIconGoogleplay = defineAsyncComponent(() => import("./_nuxt/googleplay-Duclp0YX.js").then((r) => r["default"] || r.default || r));
const LazyIconHamburger = defineAsyncComponent(() => import("./_nuxt/hamburger-DFl4Hjv3.js").then((r) => r["default"] || r.default || r));
...
const LazyIconQuote = defineAsyncComponent(() => import("./_nuxt/quote-BC1rzZCp.js").then((r) => r["default"] || r.default || r));
const LazyIconTwitter = defineAsyncComponent(() => Promise.resolve().then(() => twitter).then((r) => r["default"] || r.default || r));
const LazySymbolInfo = defineAsyncComponent(() => import("./_nuxt/SymbolInfo-B6ULAODM.js").then((r) => r["default"] || r.default || r));
const LazyTickerTape = defineAsyncComponent(() => import("./_nuxt/TickerTape-eco84yfi.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-s5lu0ZnG.js").then((m) => m.default || m))
};
...
export {
  ...
  entry$1 as default,
  usePreloadDone as e,
  __nuxt_component_2$2 as f,
  __nuxt_component_2$3 as g,
  useIntervalFn as h,
  useSplitTextDone as i,
