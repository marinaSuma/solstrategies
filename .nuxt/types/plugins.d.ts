...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../app/plugins/configdefault.client")> &
  InjectionType<typeof import("../../app/plugins/credit.client")> &
  InjectionType<typeof import("../../app/plugins/linereveal.client")> &
  InjectionType<typeof import("../../app/plugins/mobilebar.client")> &
  InjectionType<typeof import("../../app/plugins/smoothscroll.client")> &
  InjectionType<typeof import("../../app/plugins/splittext.client")> &
  InjectionType<typeof import("../../app/plugins/windowresize.client")> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt-site-config:init' | 'nuxt:payload' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt-seo:fallback-titles' | 'nuxt-schema-org:defaults' | 'nuxt-schema-org:init' | 'configdefault' | 'credit' | 'linereveal' | 'mobilebar' | 'lenis' | 'splittext' | 'windowresize' | 'nuxt-seo:defaults'
  }
}
